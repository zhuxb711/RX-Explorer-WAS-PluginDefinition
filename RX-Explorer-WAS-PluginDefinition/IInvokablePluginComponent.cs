...
namespace RX_Explorer_WAS.PluginDefinition
{
    ...
    public interface IInvokablePluginComponent : IPluginComponent
    {
        ...
        /// </remarks>
        public Task InvokeFeatureAsync(IPluginFeatureInformation Feature, FeatureStatus Status, IEnumerable<object> Parameters, CancellationToken CancelToken = default);
    }
}
